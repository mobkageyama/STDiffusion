...
#   # if data_name == 'stock':
#   #   ori_data = np.loadtxt('../datasets/stock.csv', delimiter = ",",skiprows = 1)
#   # elif data_name == 'energy':
#   #   ori_data = np.loadtxt('../datasets/energy.csv', delimiter = ",",skiprows = 1)

#   ori_data = np.loadtxt(f'../datasets/{data_name}.csv', delimiter = ",",skiprows = 1)
...
def real_data_loading(data_name, seq_len):
    if data_name == 'sine':
        return np.load('../generated_datasets/real_data_npy/sine.npy')
