...
def visualization(ori_data, generated_data, analysis, compare=3000, data_name=None):
  ...
  """
    ...
    if analysis == 'pca':
        ...
        f, ax = plt.subplots(1)
        sns.distplot(prep_data, hist=False, kde=True, kde_kws={'linewidth': 5, 'linestyle':'--'}, label='Original', color="red")
        sns.distplot(prep_data_hat, hist=False, kde=True, kde_kws={'linewidth': 5, 'linestyle':'--'}, label='STDiffusion', color="blue")
        ...
        plt.ylabel(f'Data Density Estimate')
